        ...
        <div class="five-columns">
            <div class="column">
                <div class="menu-element">
                    <button type="button" class="menu-item" data-url="{{route('admin_users')}}" data-section="users">
            ...
            <div class="column">
                <div class="menu-element">
                    <button type="button" class="menu-item" data-url="{{route('admin_faqs')}}" data-section="faqs">
                        <svg viewBox="0 0 24 24">
            ...
            <div class="column">
                <div class="menu-element">
                    <button type="button" class="menu-item" data-url="{{route('admin_blog')}}" data-section="blog">
                        <svg viewBox="0 0 24 24">
            ...
            <div class="column">
                <div class="menu-element">
                    <button type="button" class="menu-item" data-url="{{route('admin_home')}}" data-section="home">
                        <svg viewBox="0 0 24 24">
            ...
            <div class="column">
                <div class="menu-element">
                    <button type="button" class="menu-item" data-url="{{route('admin_messages')}}" data-section="messages">
                        <svg viewBox="0 0 24 24">
