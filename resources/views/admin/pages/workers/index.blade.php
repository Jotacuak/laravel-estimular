...
@section('table')
    ...
    <div class="admin-table" id="workers">
            ...
            @foreach ($workers as $workers_element)
                <div class="admin-table-elements">
                    ...
                    <div class="admin-table-element-button">
                            <button type="button" id="edit-button" data-url="{{route('workers_edit', ['workers' => $workers_element->id])}}">
                    ...
                    <div class="admin-table-element-button">
                            <button type="button" id="delete-button" data-url="{{route('workers_destroy', ['workers' => $workers_element->id])}}">
                                <svg viewBox="0 0 24 24">
                ...
                <div class="content">
                    <div data-content="zero" class="tabcontent active">
                        ...
                        <div class="crud-form-elements">
                            ...
                            <div class="crud-form-element">
                                <textarea class="ckeditor" name="description" id="ckeditor" value="{{isset($workers->description) ? $workers->description : ''}}"></textarea>
                            </div>
                        </div>        
                    </div>
