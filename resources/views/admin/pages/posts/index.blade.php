            ...
            @foreach ($posts as $posts_element)
                <div class="admin-table-elements">
                    ...
                    <div class="admin-table-element-button">
                            <button type="button" id="edit-button" data-url="{{route('posts_edit', ['posts' => $posts_element->id])}}">
                    ...
                    <div class="admin-table-element-button">
                            <button type="button" id="delete-button" data-url="{{route('posts_destroy', ['posts' => $posts_element->id])}}">
                                <svg viewBox="0 0 24 24">
