            ...
            @foreach ($faqs_categories as $faq_category_element)
                <div class="admin-table-elements">
                    <div class="admin-table-element-info">
                        <ul>
                            <li class="info-element">{{$faq_category_element->id}}</li>
                            <li class="info-element">{{$faq_category_element->name}}</li>
                        </ul>
                    </div>
                    <div class="admin-table-element-buttons">
                    <div class="admin-table-element-button">
                            <button type="button" id="edit-button" data-url="{{route('faqs_categories_edit', ['faq' => $faq_category_element->id])}}">
                    ...
                    <div class="admin-table-element-button">
                            <button type="button" id="delete-button" data-url="{{route('faqs_categories_destroy', ['faq' => $faq_category_element->id])}}">
                                <svg viewBox="0 0 24 24">
            ...
            <div class="content">
                <div data-content="zero" class="tabcontent active">
                    ...
                    <div class="crud-form-elements">
                        ...
                        <div class="crud-form-element">
                            <input class="title-bar" type="text" id="title" name="name" value="{{isset($faq_category->name) ? $faq_category->name : ''}}">
                        </div>
                    </div>
                </div>
            </div>
