            ...
            @foreach ($posts_categories as $posts_category_element)
                <div class="admin-table-elements">
                    ...
                    <div class="admin-table-element-button">
                            <button type="button" id="edit-button" data-url="{{route('posts_categories_edit', ['posts' => $posts_category_element->id])}}">
                    ...
                    <div class="admin-table-element-button">
                            <button type="button" id="delete-button" data-url="{{route('posts_categories_destroy', ['posts' => $posts_category_element->id])}}">
                                <svg viewBox="0 0 24 24">
