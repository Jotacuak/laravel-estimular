...
@section('table')
    ...
    <div class="admin-table" id="therapies">
            ...
            @foreach ($therapies as $therapies_element)
                <div class="admin-table-elements">
                    ...
                    <div class="admin-table-element-button">
                            <button type="button" id="edit-button" data-url="{{route('therapies_edit', ['therapies' => $therapies_element->id])}}">
                    ...
                    <div class="admin-table-element-button">
                            <button type="button" id="delete-button" data-url="{{route('therapies_destroy', ['therapies' => $therapies_element->id])}}">
                                <svg viewBox="0 0 24 24">
        ...
        <div class="crud-form">
            <form action="{{route("therapies_store")}}" class="admin-form" id="therapies-form" autocomplete="off">
                <div class="crud-form-buttons">
                    ...
                    @include('admin.components.form_buttons', ['visible' => $therapy->visible])
                        ...
                        <div class="crud-form-elements">
                            <div class="two-columns">
                                <div class="form-group">                                
                                    ...
                                    <div class="crud-form-element">
                                        <input class="input-bar" type="text" name="name" value="{{isset($therapies->name) ? $therapies->name : ''}}">
                                    </div>                                
                                </div>
                            </div>
                            ...
                            <div class="crud-form-element">
                                <input class="input-bar" type="text" name="title" value="{{isset($therapies->title) ? $therapies->title : ''}}">
                            </div>
                            ...
                            <div class="crud-form-element">
                                <textarea class="ckeditor" name="description" id="ckeditor" value="{{isset($therapies->description) ? $therapies->description : ''}}">{{isset($therapy["description"]) ? $therapy["description"] : ''}}</textarea>
                            </div>
                        </div>        
                    </div>
