                                ...
                                <div class="contact-info">
                                    ...
                                    <div class="desktop-two-columns">
                                        <div class="contact-info-option">
                                            ...
                                            <div class="contact-info-option-text">
                                                <p>la.lloreria@crymeariver.com</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="desktop-two-columns">
                                        <div class="contact-info-option">
                                            ...
                                            <div class="contact-info-option-text">
                                                <p>Carrer Colubí, 18</p>
                                                <p>07013. Palma de Mallorca. Islas Baleares.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form enctype="multipart/form-data" class="front-form" id="contact-form" name="sql_file">
                                    ...
                                    <div class="column">
                                        <div class="contact-form-element-button">
                                            <button  class="pink-button submit-button" type="submit">Enviar</button>
                                        </div>                                    
                                    </div>
                                </form>
                            </div>
